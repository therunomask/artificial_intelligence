 ...
 *
 * -write test that reads out activity pattern of cells in a specific segment
 * use this test on new segments
* --check again if all cells in a segment are active simultaneously
 *
 *
 ...
 * Dopaminsystem?
 *
 * try to find an abstract description of learning algorithm as
 * some mathematical flow inside some abstract space
 * --maybe seek inspiration by some flow generated by
 * normalised linear combination of gaussians
 *
 * think about shape space idea...
 *
